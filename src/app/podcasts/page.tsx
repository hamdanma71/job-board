...
export default function PodcastsHub() {
  ...
  const podcasts = [
    { id: 1, title: t("podcasts.ep42"), host: t("podcasts.showName"), duration: t("podcasts.dur45"), image: "🎧", tags: [t("podcasts.tagInterviews"), t("podcasts.tagTech")] },
    { id: 2, title: t("podcasts.ep41"), host: t("podcasts.showName"), duration: t("podcasts.dur38"), image: "🎙️", tags: [t("podcasts.tagGrowth"), t("podcasts.tagTips")] },
    { id: 3, title: t("podcasts.ep40"), host: t("podcasts.showName"), duration: t("podcasts.dur52"), image: "💼", tags: [t("podcasts.tagSalary"), t("podcasts.tagNegotiation")] },
    { id: 4, title: t("podcasts.ep39"), host: t("podcasts.showName"), duration: t("podcasts.dur41"), image: "🌍", tags: [t("podcasts.tagRemote"), t("podcasts.tagMarket")] },
  ];
  ...
  return (
    <main style={{ backgroundColor: "#000", color: "#fff", minHeight: "100vh" }}>
      ...
      <section className="container" style={{ padding: "2rem 1.5rem 6rem 1.5rem" }}>
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: "bold", marginBottom: "2rem", borderBottom: "1px solid #333", paddingBottom: "1rem" }}>{t("podcasts.latestEpisodes")}</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {podcasts.map((podcast, index) => (
            <div key={podcast.id} style={{
              ...
              <div className="podcast-tags" style={{ gap: "0.5rem", marginInlineStart: "2rem" }}>
        ...
        <div style={{ marginTop: "4rem", backgroundColor: "#121212", padding: "3rem", borderRadius: "12px", textAlign: "center" }}>
          <h2 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "1rem" }}>{t("podcasts.availableEverywhere")}</h2>
          <p style={{ color: "#b3b3b3", marginBottom: "2rem" }}>{t("podcasts.subscribeFavorite")}</p>
